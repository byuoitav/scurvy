...
import (
	...
	"github.com/byuoitav/scurvy/atlona4x1"
...
func main() {
	...
	pflag.StringVarP(&username, "username", "u", "", "The username of the switcher to test")
	pflag.StringVarP(&password, "password", "p", "", "The password of the switcher to test")
	...
	d := atlona4x1.New(username, password, address)
